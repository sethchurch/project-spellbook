export const basicCharacterPrompt = [
  ...
  'You will be provided a character backstory below your job is to turn that backstory into a character build guide up to level 20.',
  'Include race, class, stats (you can use standard array), backgrounds, items, feats, spells, and any other features or equipment you think would be appropriate for the character based on the backstory.',
  'Also provide a number of skills the character is proficent in appropriate for the level and class (typically 2 to 4 skills from class plus 2 from background).',
