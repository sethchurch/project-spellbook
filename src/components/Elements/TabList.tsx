...
const styleVariants = {
  default: {
    ...
    tab: 'max-w-fit px-0 p-0 h-full rounded-none datadata-[hover-unselected=true]:opacity-100 data-[hover-unselected=true]:rounded-t-lg rounded-t-lg dark:bg-zinc-950 bg-stone-200',
    panel:
